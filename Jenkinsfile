    ...
    stage('Stage III: SCA') {
      steps {
        ...
        withCredentials([string(credentialsId: 'nvd-api-key', variable: 'NVD_API_KEY')]) {
          sh "export JAVA_HOME=/usr/lib/jvm/java-11-openjdk-amd64; export PATH=\$JAVA_HOME/bin:\$PATH; mvn org.owasp:dependency-check-maven:12.1.0:check -DnvdApiKey=${NVD_API_KEY}"
        }
